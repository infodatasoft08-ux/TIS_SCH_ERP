...
export default function RegistrationPage() {
  ...
  const handleStudentSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const submissionData = { ...studentForm, password: studentForm.phone };
      const res = await API.post('/registration/student', submissionData);
  ...
  const handleTeacherSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const submissionData = { ...teacherForm, password: teacherForm.phone };
      const res = await API.post('/registration/teacher', submissionData);
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="+91 9123456780" required
                      className="rounded-xl border-gray-200 dark:border-gray-700 py-2.5 focus-visible:ring-indigo-500"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="+91 9888123456" required
